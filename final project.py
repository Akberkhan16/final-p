...
class admin:
    def add_new_food_items(self,id,name,quantity,price,discount):
...
food1=food_items( '1','biryani','1 plate','Rs.220','5%')    
food2=food_items('2','rumali roti','1 pieces','Rs.20','5%')
food3=food_items('3', 'chi 65','1 Plate', 'Rs.260','5%')
food4=food_items("4",'thumps up','750 ml','1 bottle','5%')
...
class list_of_food_items():
    ...
    foods=['chicken biryani','chi 65','rumali roti','thumps up']   
...
print(user1.registration('akber',799548533,'mdakber@gmail','hyderabad','pathan'))
print(user1.login('akber','pathan'))
...
for i in foods:
    ...
    def update_profile(update_profile):
        if "akber khan" != "akber pathan":
            return "\nprofile  updated"
        if 'akber khan'=='akber pathan':
            return '\nyour profile not  updated'
        
        
s1=update_profile('akber pathan')
print(s1)
